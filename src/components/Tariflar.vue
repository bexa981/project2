...
<template>
    <div class="tariflar-main">
        <h2 data-aos="fade-up" data-aos-duration="1500">Tariflar</h2>
...
.cards .tarif button {
    ...
    border: none;
    border-radius: 20px;
    box-shadow: 1px 5px 10px rgb(174, 174, 174);
    transition: .3s;
    cursor: pointer;
}

.cards .tarif button:hover {
    background-color: rgb(193, 93, 93);
}
